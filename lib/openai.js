...
async function generateEmails(apiKey, prompt) {
  ...
  console.log('Total input:', systemPrompt.length + prompt.length, 'chars');
  console.log('Estimated tokens:', Math.ceil((systemPrompt.length + prompt.length) / 4));
