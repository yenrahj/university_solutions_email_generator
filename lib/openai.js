...
NEVER put negative news, declining numbers, or challenges in the PROSPECT'S story. Put them in the PARTNER'S story.

BAD: "Your enrollments declined 15%" or "Your MBA dropped from 133 to 67" or "Your completions are flat"
GOOD: "One of our partners reversed similar declines..." (the problem lives in the partner story - they self-identify)

You can SOFTLY acknowledge ("completions dipped", "mixed results") but NEVER cite their specific negative numbers.
...
BAD: "I saw your programs have been struggling."
...
**5. FOLLOW THE STYLE FROM RESEARCH**
The prospect research will specify which style to use for Email 1, Email 2, and Email 4. 
FOLLOW THESE STYLE INSTRUCTIONS - they are chosen based on the prospect's persona.
Look for "Email 1 Style:", "Email 2 Style:", "Email 4 Style:" in the research.

## EMAIL BODY STYLES (use the style specified in research)
...
1. 🚨 Did you put ALL negative news/numbers in the PARTNER story, NOT the prospect's story?
2. Did you use VARIETY in email body styles across the sequence?
3. Did you use VARIETY in subject line styles?
